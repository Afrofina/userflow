        ...
        <div className="flex justify-center w-full h-full">
          <div className="lg:w-9/12 w-full h-full overflow-auto lg:px-10 px-4">
            <div className="lg:pt-8 pt-0">
              <Text
                className="!text-[20px] text-black custom-font !tracking-widest lg:block hidden"
                align="center"
              >
                Send and Recipient details
              </Text>
              <Text
                className="!text-[16px] text-[#575757] sf-pro pt-3"
                align="center"
              >
            ...
            <div className="space-y-5 pt-12">
              <Text
                className="!text-[20px] text-black custom-font !tracking-widest"
                align="left"
              >
                Senders details
              </Text>
              <Input
                ...
                className="border border-black rounded w-full placeholder-black text-black px-10 py-3 sf-pro text-[18px]"
              />
              <div className="flex justify-between border border-black rounded w-full  px-10 py-3">
                <Input
                  placeholder="Comapny Name"
                  className=" placeholder-black text-black  sf-pro text-[18px] w-full focus:outline-none"
                />
                <Text
                  className="text-black  sf-pro text-[18px] w-48"
                  align="right"
                >
                  if applicable
                </Text>
              ...
              <div className="flex justify-between border border-black rounded w-full  px-10 py-3">
                ...
                />
                <Text
                  className="text-black  sf-pro lg:!text-[18px] !text-[14px] w-48"
                  align="right"
                >
                  Use account email
                </Text>
            ...
            <div className="space-y-5 pt-6">
              ...
              <div className="flex justify-center pt-4 pb-8">
                <Link
                  href={"/ecom/ship/standard-shipping/item-details"}
