    ...
    <div>
      ...
      <div className="border border-gray-900 px-5 rounded pb-6 pt-1 mt-6">
        ...
        <div className="flex items-center justify-between">
          <Text
            variant="body1"
            className="!text-xl custom-font text-black !tracking-widest"
          >
            1000
          </Text>
          <Text
      ...
      <Text
        variant="h6"
        className="text-black custom-font !tracking-widest py-6"
      >
        Recipient Details
      </Text>
      <div className="md:p-3 p-2 rounded border border-gray-300 flex md:flex-row flex-col items-center">
        <div className="grid grid-cols-2 w-full">
          <div className="space-y-1 flex flex-col items-start">
            <Text
              align="left"
              className="text-[#707070] md:!text-[18px] !text-[14px]"
            >
              Email :
            </Text>
            <Text
