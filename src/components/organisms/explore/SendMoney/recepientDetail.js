  ...
  return (
    <div>
      ...
      <LabelInput
        ...
        mainClass="py-10 space-y-1"
      />
      <Text
        variant="h6"
        className="text-black custom-font !tracking-wider !text-lg"
        align="left"
      >
        Recipient bank details
      </Text>
      <LabelInput
        text="Full name of account holder"
        placeholder=""
        mainClass="pt-6 space-y-1"
      />
      <LabelInput
        text="ACH Routing number "
        placeholder=""
        mainClass="pt-4 space-y-1"
      />
      <LabelInput
        text="Account number  "
        placeholder=""
      ...
      <div className="grid lg:grid-cols-3 grid-cols-2 pt-2 pb-12 gap-3">
        <div className="border border-[#333333] p-3 rounded pb-6 ">
          ...
          <TextIcon
            iconSrc="/sendMoney/wallet.svg"
            iconWidth={40}
            text="Checking"
            textClass="text-black text-[#333333]"
          />
        </div>
        <div className="border border-[#039A00] p-3 rounded pb-6">
          ...
          <TextIcon
            iconSrc="/sendMoney/saving.svg"
            iconWidth={40}
            text="Savings"
            textClass="text-[#039A00]"
          />
        </div>
      </div>
      <Text
      ...
      <LabelInput text="Zip Code " placeholder="" mainClass="pt-4 space-y-1" />
      <LabelInput
        text="Country "
        placeholder=""
        mainClass="pt-4 space-y-1 pb-4"
      />
