  ...
  return (
    <div className="space-y-6 pb-24">
      <div className="space-y-2 pb-5 pt-6">
        ...
        <Text>Please fill in your patient details</Text>
      </div>
      <form className="space-y-3">
        ...
        <Text
          variant="h6"
          className="text-black font-media-sans-semicondensed custom-font lg:block"
        >
          Hospital details
        </Text>
      ...
      <Link href="/ecom/explore/pay-utility/hospital-amount">
