    ...
    <div className="h-full">
      <div className="grid lg:grid-cols-3 grid-cols-1 px-10 pt-8 h-full gap-8 pb-4">
        <div className="overflow-auto">
          <Text
            className="text-black !text-[24px] custom-font !tracking-widest pb-4 lg:block hidden"
            align="left"
          >
            product
          </Text>
        ...
        <div className="flex flex-col h-full">
          ...
          <div
            ...
            style={{
              backgroundImage: `url('/shop/story.png')`,
        ...
        <div className="flex flex-col justify-end items-start space-y-4">
          <Button
            className="bg-[#878787] px-6 py-2 rounded text-[18px] font-extralight"
