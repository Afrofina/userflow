      ...
      <div className="space-y-5 pt-10">
        <div className="py-4 px-4 rounded border border-black bg-white">
          <div className="">
            ...
            <div className="py-6">
              <Text
                className="text-black lg:!text-[18px] !text-[14px] sf-pro"
                align="left"
              >
                Send us an email
              </Text>
              <Text
                className="text-black lg:!text-[12px] !text-[10px] sf-pro "
                align="left"
              >
          ...
          <Text
            className="text-black lg:!text-[14px] !text-[10px]  sf-pro underline pb-[0.5] "
            align="left"
          >
