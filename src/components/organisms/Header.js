  ...
  return (
    <div className="shadow-sm py-4 bg-[#FEFBFF] sticky border-b border-black flex items-center lg:px-6 px-4  justify-between">
      ...
      <div className="lg:hidden block ">
        <TextIcon
          text="Back"
          iconSrc="/header/left.svg"
          textClass="text-black !text-xs"
          mainClass="flex items-center lg:space-x-3 space-x-2"
          onClick={() => router.back()}
        ></TextIcon>
      </div>
      <Text
        variant={"h6"}
        className="text-black custom-font lg:hidden block !tracking-widest"
        align="center"
      >
        {title}
      </Text>
      <div className="flex items-center lg:space-x-3 space-x-0">
        <Link href="/ecom/shop/cart">
          <TextIcon
            ...
            mainClass=" items-center space-x-3 lg:flex hidden"
          />
        </Link>
        <Link href="/ecom/shop/cart">
          <TextIcon
        ...
        <Notification
          button={
            <TextIcon
              iconSrc="/header/notification.svg"
              text="notification"
              textClass="text-black"
              mainClass=" items-center space-x-3 lg:flex hidden"
            />
        ...
        <div className="flex items-center space-x-3 lg:pl-4 pl-0 lg:border-l border-l-0 border-black">
          <Option
            button={
              <Image
                src={"/header/options.svg"}
                width={24}
                height={24}
                className={"lg:w-auto w-[14.68px]"}
              />
            }
          />
